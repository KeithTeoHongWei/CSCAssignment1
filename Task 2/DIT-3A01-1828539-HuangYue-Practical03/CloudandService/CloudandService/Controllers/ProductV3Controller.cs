...
namespace CloudandService.Controllers
{
    public class ProductV3Controller : ApiController
    {
        ...
        //But according to the HTTP/1.1 protocol, when a POST request results in thecreation of a resource, the server should reply with status 201 (Created).
